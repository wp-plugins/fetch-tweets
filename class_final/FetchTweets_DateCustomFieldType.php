<?php
class FetchTweets_DateCustomFieldType extends FetchTweets_AdminPageFramework_CustomFieldType {
	...
	protected function getEnqueuingStyles() { 
		return array(
			FetchTweets_Commons::getPluginDirPath() . '/css/jquery-ui/jquery-ui-1.10.3.min.css',
		); 
	}	
