 ...
 */
abstract class FetchTweets_AdminPageFramework_Pages {
 ...
 * @subpackage		Admin Page Framework - Property
 */
class FetchTweets_AdminPageFramework_Properties {
	...
	*/
	public function __construct( $strPostType, $arrArgs=array(), $strCallerPath=null ) {
		...
		if ( $this->strPostType != '' && is_admin() ) {			
			...
			// Links
			$this->oLink = new FetchTweets_AdminPageFramework_LinkForPostType( $this->strPostType, $this->strCallerPath );
...
abstract class FetchTweets_AdminPageFramework_MetaBox {
	...
	*/ 
	...
	private function addColorFieldScript( &$arrField ) {
		...
		$this->strScript .= FetchTweets_AdminPageFramework_Properties::getColorPickerScript();
	...
	private function addImageFieldScript( &$arrField ) {
		...
		// Append the script
		$this->strScript .= FetchTweets_AdminPageFramework_Properties::getImageSelectorScript( "admin_page_framework", $this->strThickBoxTitle, $this->strThickBoxButtonUseThis );
	...
	public function addStyle() {
		...
		// Print out the filtered styles.
		$this->strStyle = $this->oUtil->addAndApplyFilters( $this, "style_{$this->strClassName}", FetchTweets_AdminPageFramework_Properties::$strDefaultStyle );
		if ( ! empty( $this->strStyle ) )
	...
	private function getField( $arrField ) {
		...
		$oField = new FetchTweets_AdminPageFramework_InputField( $arrField, $this->arrOptions, array(), $this->oMsg );	// currently error arrays are not supported for meta-boxes 
